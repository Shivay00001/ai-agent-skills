---
name: reticle
description: AI agent verification layer that proofreads AI-written code against the real running web app. Gives agents runtime perception � network calls, store state, console, DOM � returning pass/fail verdicts with file:line to fix. Works with React, Vue, Svelte, Next.js, Vite, Electron, Tauri, and any MCP agent.
---
